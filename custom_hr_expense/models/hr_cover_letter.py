...
class HrCoverLetter(models.Model):
    ...
    total_ex_sale_amount = fields.Float(compute='_compute_total_sale_amount')
    total_ex_cost_amount = fields.Float(compute='_compute_total_sale_amount')

    total_of_sale_amount = fields.Float(compute='_compute_total_sale_amount')
    total_of_cost_amount = fields.Float(compute='_compute_total_sale_amount')

    total_sale_amount = fields.Float(compute='_compute_total_sale_amount')
    total_cost_amount = fields.Float(compute='_compute_total_sale_amount')
    ...
    ex_is_console = fields.Boolean(compute='compute_ex_is_console', store=True)
    off_is_console = fields.Boolean(compute='compute_off_is_console', store=True)
    all_approved = fields.Boolean(compute='compute_all_approved')
    checked = fields.Boolean()
    total_gl = fields.Float(compute='compute_remaining_balance', store=True)
    remaining_balance = fields.Float(compute='compute_remaining_balance', store=True)
