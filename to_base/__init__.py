...
def get_viin_brand_resource_path(mod, *args):
    ...
    # exists in viin_brand/static/src/img/favicon.ico
    if mod == 'web' and 'static/src/img/favicon.ico' in args:
        viindoo_favicon_path = get_resource_path('viin_brand', *args)
...
def _update_favicon(env):
    img_path = module.get_resource_path('viin_brand', 'static/src/img/favicon.ico')
    if img_path:
