...
class AttendanceSheet(models.Model):
    ...
    def _compute_sheet_total(self):
        ...
        """
        for sheet in self:
            grace_period = self.employee_id.resource_calendar_id.grace_period
            print('GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG', grace_period)
                    ...
                    if public_holiday:
                        ...
                        for i, work_interval in enumerate(work_intervals):
                            ...
                            overtime = timedelta(hours=00, minutes=00,
                                                 seconds=00)
                            grace_period_seconds = grace_period * 60  # Convert grace_period to seconds
                            ...
                            if att_work_intervals:
                                if len(att_work_intervals) > 1:
                                    ...
                                    late_in_interval = (
                                        max(work_interval[0],
                                            att_work_intervals[0][0] - timedelta(seconds=grace_period_seconds)),
                                        att_work_intervals[0][0]
                                    )
                                    print('LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL',late_in_interval)
                                    overtime_interval = (
                                        work_interval[1],
    ...
    def action_create_payslip(self):
        ...
        for sheet in self:
            ...
            # new_payslip._onchange_employee()  this method changed in odoo 15 to compute methods
